...
# ── LOGO HELPER ────────────────────────────────────────────────────────────────
# Logo loaded via st.image() in header — see render_header()
...
# Overlay DKM logo using st.image in a fixed top-right position
import pathlib
_logo_path = pathlib.Path(__file__).parent / "dkm_logo.png"
